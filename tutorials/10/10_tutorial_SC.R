...
df <- read.csv("/Users/sarabcidf/Desktop/ASDS/Statistics/StatsI_Fall2023/tutorials/10/ESS10.csv")
...
# Save dataset
write.csv(df_s, "/Users/sarabcidf/Desktop/ASDS/Statistics/StatsI_Fall2023/tutorials/10/ess_euroscepticism.csv")

# Initial investigation ----------
df <- read.csv("/Users/sarabcidf/Desktop/ASDS/Statistics/StatsI_Fall2023/tutorials/10/ess_euroscepticism.csv", row.names="X")
View(df)
...
# What is the prediction equation? NO ERROR TERM, ITS PREDICTION
# euroskep = 4.47 - 0.02669(education)
