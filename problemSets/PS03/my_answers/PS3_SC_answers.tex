...
\noindent We are interested in knowing how the difference in campaign spending between incumbent and challenger affects the incumbent's vote share. 
	\begin{enumerate}
		...
		\lstinputlisting[language=R, linerange={39-40}]{PS3_SC_answers.R} \vspace{5cm}
		
		\item Make a scatterplot of the two variables and add the regression line. 	\vspace{0.5cm}
		
		\lstinputlisting[language=R, linerange={45-53}]{PS3_SC_answers.R}
		...
		\lstinputlisting[language=R, linerange={42-43}]{PS3_SC_answers.R}
		...
		\begin{flalign*}
			&\text{VoteSh} = \beta_0 + \beta_1 \cdot \text{DiffLog} + \varepsilon &
		\end{flalign*}
...
\noindent We are interested in knowing how the difference between incumbent and challenger's spending and the vote share of the presidential candidate of the incumbent's party are related.	\vspace{.25cm}
	\begin{enumerate}
		...
		\lstinputlisting[language=R, linerange={57-58}]{PS3_SC_answers.R}
		
		\item Make a scatterplot of the two variables and add the regression line. \vspace{0.5cm}
		
		\lstinputlisting[language=R, linerange={63-71}]{PS3_SC_answers.R}
		...
		\lstinputlisting[language=R, linerange={60-61}]{PS3_SC_answers.R}
		...
		{\setlength{\abovedisplayskip}{2pt} 
			...
			\begin{flalign*}
				&\text{PresSh} = \beta_0 + \beta_1 \cdot \text{DiffLog} + \varepsilon &
			\end{flalign*}
...
\noindent We are interested in knowing how the vote share of the presidential candidate of the incumbent's party is associated with the incumbent's electoral success.
	...
	\begin{enumerate}
		...
		\lstinputlisting[language=R, linerange={78-79}]{PS3_SC_answers.R}
			
		\item Make a scatterplot of the two variables and add the regression line. \vspace{0.5cm}
		
		\lstinputlisting[language=R, linerange={81-89}]{PS3_SC_answers.R}
		...
		{\setlength{\abovedisplayskip}{2pt} 
			...
			\begin{flalign*}
				&\text{VoteSh} = \beta_0 + \beta_1 \cdot \text{PresSh} + \varepsilon &
			\end{flalign*}
...
\noindent The residuals from part (a) tell us how much of the variation in \texttt{voteshare} is $not$ explained by the difference in spending between incumbent and challenger. The residuals in part (b) tell us how much of the variation in \texttt{presvote} is $not$ explained by the difference in spending between incumbent and challenger in the district.
	\begin{enumerate}
		...
		\lstinputlisting[language=R, linerange={92-93}]{PS3_SC_answers.R}
		
		\item Make a scatterplot of the two residuals and add the regression line. 	\vspace{0.5cm}
		
		\lstinputlisting[language=R, linerange={95-103}]{PS3_SC_answers.R}
		...
		{\setlength{\abovedisplayskip}{2pt} 
			...
			\begin{flalign*}
				&\text{Resid1} = \beta_0 + \beta_1 \cdot \text{Resid2} + \varepsilon &
			\end{flalign*}
